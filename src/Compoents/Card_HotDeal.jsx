    ...
    >
      ...
      <div className="border-t border-white mt-[6px] ">
        <div className="flex flex-col items-center">
          <div className="text-[9px] md:text-[14px] mt-[03px] text-black font-bold">
            {item.title}
          </div>
        </div>

        <div className="flex justify-center items-center px-[5px] mt-[8px] mb-[5px]">
          <p className=" text-[7px] md:text-[10px] bg-black px-[4px] py-[2px] text-white font-bold rounded-[2px]">
            Add to cart
          </p>
        </div>
      </div>
      <span className=" absolute top-[2px] right-[2px] md:top-[3px] md:right-[2px] text-[5.5px] md:text-[10px]  bg-black w-fit px-[07px] py-[1px] rounded-[3px] text-white font-bold">
        {item.price}$
      </span>
    </div>
  );
